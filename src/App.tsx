...
function App() {
  return (
    <ThemeProvider>
      <div className="min-h-screen transition-colors duration-500 bg-beige dark:bg-green-900 flex flex-col items-center justify-between font-serif relative overflow-hidden">
